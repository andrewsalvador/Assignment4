...
lobster_table_2012 %>% 
  ...
  add_header_above(c("2012 Lobster Size Summary" = 4), font_size = 20, color = "blue")
...
lobster_table_2018 %>% 
  ...
  kable_styling(bootstrap_options = "striped", 
    ...
    add_header_above(c("2018 Lobster Size Summary" = 4), font_size = 20, color = "blue") 
